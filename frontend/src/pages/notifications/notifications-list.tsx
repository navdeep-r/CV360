...
import {setRefetch, uploadCsv} from '../../stores/notifications/notificationsSlice';
...
const NotificationsTablesPage = () => {
  ...
  return (
    <>
      ...
      <SectionMain>
        <SectionTitleLineWithButton icon={mdiChartTimelineVariant} title="Notifications" main>
        {''}
        </SectionTitleLineWithButton>
        <CardBox   className='mb-6' cardBoxClassName='flex flex-wrap'>
          <BaseButton className={'mr-3'} href={'/notifications/notifications-new'} color='info' label='New Item' />
          <BaseButton
              className={'mr-3'}
              color='info'
              label='Filter'
              onClick={addFilter}
          />
          <BaseButton className={'mr-3'} color='info' label='Download CSV' onClick={getNotificationsCSV} />
            <BaseButton
              color='info'
              label='Upload CSV'
