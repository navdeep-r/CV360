...
import { create } from '../../stores/upvotes/upvotesSlice'
...
const UpvotesNew = () => {
  ...
  <FormField label="Complaint" labelFor="complaint">
      <Field name="complaint" id="complaint" component={SelectField} options={[]} itemRef={'complaints'}></Field>
  </FormField>
...
UpvotesNew.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
