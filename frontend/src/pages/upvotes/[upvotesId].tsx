...
const EditUpvotes = () => {
  ...
  const { upvotesId } = router.query

  useEffect(() => {
    dispatch(fetch({ id: upvotesId }))
  }, [upvotesId])
  ...
  const handleSubmit = async (data) => {
    await dispatch(update({ id: upvotesId, data }))
...
EditUpvotes.getLayout = function getLayout(page: ReactElement) {
  return (
      <LayoutAuthenticated>
          {page}
      </LayoutAuthenticated>
