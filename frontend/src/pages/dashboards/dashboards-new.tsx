...
const DashboardsNew = () => {
  ...
  <FormField label="Official" labelFor="official">
      <Field name="official" id="official" component={SelectField} options={[]} itemRef={'users'}></Field>
  </FormField>

  <FormField label="Admin" labelFor="admin">
      <Field name="admin" id="admin" component={SelectField} options={[]} itemRef={'users'}></Field>
  </FormField>
