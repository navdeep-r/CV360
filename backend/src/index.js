  ...
  definition: {
    openapi: "3.0.0",
      info: {
        version: "1.0.0",
        title: "CV360",
        description: "CV360 Online REST API for Testing and Prototyping application. You can perform all major operations with your entities - create, delete and etc.",
      },
    servers: [
      {
...
app.use('/api/upvotes', passport.authenticate('jwt', {session: false}), upvotesRoutes);
